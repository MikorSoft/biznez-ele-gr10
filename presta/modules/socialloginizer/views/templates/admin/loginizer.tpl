...
<div style="font-size: 15px;padding-left: 4%;padding-top: 12px; display: block; padding: 10px 15px 10px 15px; background-color: #FFF8DC; text-align: center; border: 1px solid #E0DCBF;">
    {l s='Paid Version with full features.' mod='socialloginizer'}
    <a target="_blank" href="https://ps.knowband.com/demo1/16/admin1/" style="text-decoration: none;">
        <span style="color: white;background-color: #79BD3C;padding: 6px 20px;border-radius: 3px;font-size: 13px;margin-left: 10px;text-shadow: chartreuse;">
            {l s='Check Demo' mod='socialloginizer'}
        </span>
    </a>
    <a target="_blank" href="https://www.knowband.com/prestashop-social-loginizer" style="text-decoration: none;">
        <span style="color: white;background-color: #79BD3C;padding: 6px 20px;border-radius: 3px;font-size: 13px;margin-left: 10px;text-shadow: chartreuse;">
            {l s='Buy Now' mod='socialloginizer'}
        </span>
    </a>
                                ...
                                <div class="box">
									...
									<tr class="free-disabled">
                                                    ...
                                                    <div id="tab_facebook" class="tab-pane">
                                                        <div class="block">
                                                            ...
                                                            <h4 class="kb_demo_header"><u>{l s='Note : This social login is not available in the Free version' mod='socialloginizer'}</u></h4>
                                                            <div class="block">
                                                                <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['facebook']['enable']) && ($velocity_social['facebook']['enable'] eq 1)}                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[facebook][enable]" id="fb_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[facebook][enable]" id="fb_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[facebook][app_id]" value="{if isset($velocity_social['facebook']['app_id'])}{$velocity_social['facebook']['app_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[facebook][app_secret]" value="{if isset($velocity_social['facebook']['app_secret'])}{$velocity_social['facebook']['app_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>   
								    ...
								    <tr class="free-disabled">
										...
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="facebook_mailchimp_key" disabled/>
                                                        ...
                                                        <div class="block">
                                                            ...
                                                            <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['live']['enable']) && ($velocity_social['live']['enable'] eq 1)}
                                                                                    ...
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[live][enable]" id="live_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[live][enable]" id="live_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[live][client_id]" value="{if isset($velocity_social['live']['client_id'])}{$velocity_social['live']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[live][client_secret]" value="{if isset($velocity_social['live']['client_secret'])}{$velocity_social['live']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr> 
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="live_mailchimp_key" disabled/>
                                                        ...
                                                        <div class="block">
                                                            ...
                                                            <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['linked']['enable']) && ($velocity_social['linked']['enable'] eq 1)}
                                                                                    ...
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[linked][enable]" id="linked_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[linked][enable]" id="linked_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[linked][client_id]" value="{if isset($velocity_social['linked']['client_id'])}{$velocity_social['linked']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[linked][client_secret]" value="{if isset($velocity_social['linked']['client_secret'])}{$velocity_social['linked']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>  
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="linkedin_mailchimp_key" disabled/>
									    </span>
                                                        ...
                                                        <div class="block">
                                                            ...
                                                            <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['yahoo']['enable']) && ($velocity_social['yahoo']['enable'] eq 1)}
                                                                                    ...
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[yahoo][enable]" id="yahoo_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                             
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[yahoo][enable]" id="yahoo_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[yahoo][consumer_key]" value="{if isset($velocity_social['yahoo']['consumer_key'])}{$velocity_social['yahoo']['consumer_key']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[yahoo][consumer_secret]" value="{if isset($velocity_social['yahoo']['consumer_secret'])}{$velocity_social['yahoo']['consumer_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>   
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="yahoo_mailchimp_key" disabled/>
									    </span>
                                                        ...
                                                        <div class="block">
                                                            ...
                                                            <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['insta']['enable']) && ($velocity_social['insta']['enable'] eq 1)}
                                                                                    ...
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[insta][enable]" id="insta_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[insta][enable]" id="insta_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[insta][client_id]" value="{if isset($velocity_social['insta']['client_id'])}{$velocity_social['insta']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[insta][client_secret]" value="{if isset($velocity_social['insta']['client_secret'])}{$velocity_social['insta']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="insta_mailchimp_key" disabled/>
									    </span>
									...
									<div id="insta_accordian" class="accordian_container">
									    ...
									    <td  style='padding: 8px;color:#FF2707'>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['amazon']['enable']) && ($velocity_social['amazon']['enable'] eq 1)}
                                                                                    ...
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[amazon][enable]" id="amazon_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[amazon][enable]" id="amazon_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[amazon][client_id]" value="{if isset($velocity_social['amazon']['client_id'])}{$velocity_social['amazon']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[amazon][client_secret]" value="{if isset($velocity_social['amazon']['client_secret'])}{$velocity_social['amazon']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
								    ...
								    <tr class="free-disabled">
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="amazon_mailchimp_key" disabled/>
                                                        ...
                                                        <div class="block">
                                                            ...
                                                            <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['pay']['enable']) && ($velocity_social['pay']['enable'] eq 1)}
                                                                                    ...
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[pay][enable]" id="amazon_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                             
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[pay][enable]" id="amazon_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[pay][client_id]" value="{if isset($velocity_social['pay']['client_id'])}{$velocity_social['pay']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[pay][client_secret]" value="{if isset($velocity_social['pay']['client_secret'])}{$velocity_social['pay']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>    
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="pay_mailchimp_key" disabled/>
									    </span>
                                                            ...
                                                            <div class="block">
                                                                <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['foursquare']['enable']) && ($velocity_social['foursquare']['enable'] eq 1)}                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[foursquare][enable]" id="foursquare_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[foursquare][enable]" id="foursquare_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[foursquare][client_id]" value="{if isset($velocity_social['foursquare']['client_id'])}{$velocity_social['foursquare']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[foursquare][client_secret]" value="{if isset($velocity_social['foursquare']['client_secret'])}{$velocity_social['foursquare']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr> 
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="foursquare_mailchimp_key" disabled/>
									    </span>
                                                            ...
                                                            <div class="block">
                                                                <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['github']['enable']) && ($velocity_social['github']['enable'] eq 1)}                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[github][enable]" id="github_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[github][enable]" id="github_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[github][client_id]" value="{if isset($velocity_social['github']['client_id'])}{$velocity_social['github']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[github][client_secret]" value="{if isset($velocity_social['github']['client_secret'])}{$velocity_social['github']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>     
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="github_mailchimp_key" disabled/>
									    </span>
                                                            ...
                                                            <div class="block">
                                                                <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['disqus']['enable']) && ($velocity_social['disqus']['enable'] eq 1)}                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[disqus][enable]" id="disqus_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[disqus][enable]" id="disqus_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[disqus][client_id]" value="{if isset($velocity_social['disqus']['client_id'])}{$velocity_social['disqus']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[disqus][client_secret]" value="{if isset($velocity_social['disqus']['client_secret'])}{$velocity_social['disqus']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr> 
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="disqus_mailchimp_key" disabled/>
									    </span>
                                                            ...
                                                            <div class="block">
                                                                <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['vk']['enable']) && ($velocity_social['vk']['enable'] eq 1)}                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[vk][enable]" id="vk_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[vk][enable]" id="vk_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[vk][client_id]" value="{if isset($velocity_social['vk']['client_id'])}{$velocity_social['vk']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[vk][client_secret]" value="{if isset($velocity_social['vk']['client_secret'])}{$velocity_social['vk']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr> 
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="vk_mailchimp_key" disabled/>
									    </span>
                                                            ...
                                                            <div class="block">
                                                                <table class="form">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['wordpress']['enable']) && ($velocity_social['wordpress']['enable'] eq 1)}                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[wordpress][enable]" id="wordpress_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[wordpress][enable]" id="wordpress_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[wordpress][client_id]" value="{if isset($velocity_social['wordpress']['client_id'])}{$velocity_social['wordpress']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[wordpress][client_secret]" value="{if isset($velocity_social['wordpress']['client_secret'])}{$velocity_social['wordpress']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
								    <tr class="free-disabled">
                                                                        <td class="name vertical_top_align"><span class="control-label">{l s='MailChimp Api Key' mod='socialloginizer'}: </span>                                                                
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="wordpress_mailchimp_key" disabled/>									    
									    </span>
									...
									<div id="wordpress_accordian" class="accordian_container">
									    ...
									    <td colspan="1" style='padding: 7px;color:#FF2707;'>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            {if isset($velocity_social['dropbox']['enable']) && ($velocity_social['dropbox']['enable'] eq 1)}                                                                               
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[dropbox][enable]" id="dropbox_login" checked="checked" disabled/>
                                                                                    </div>
                                                                            {else}
                                                                                    <div class="make-switch" data-on="primary" data-off="default">
                                                                                        <input class="make-switch" type="checkbox" value="1" name="velocity_social[dropbox][enable]" id="dropbox_login" disabled/>
                                                                                    </div>
                                                                            {/if}
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[dropbox][client_id]" value="{if isset($velocity_social['dropbox']['client_id'])}{$velocity_social['dropbox']['client_id']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="settings">
                                                                            <input type="text" class="text-width" name="velocity_social[dropbox][client_secret]" value="{if isset($velocity_social['dropbox']['client_secret'])}{$velocity_social['dropbox']['client_secret']|escape:'htmlall':'UTF-8'}{/if}" disabled/>
                                                                        </td>
                                                                    </tr>
								    ...
								    <tr class="free-disabled">
                                                                        ...
                                                                        <td class="settings">
										<span style="display: inline-block;width:89%;">
                                                                            <input type="text" class="text-width" readonly id="dropbox_mailchimp_key" disabled/>
									    </span>
