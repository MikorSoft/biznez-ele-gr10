...
//			Configuration::deleteByName('VELOCITY_SOCIAL_LOGINIZER');
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submit_form'))
		{
			...
			$temp_default['facebook']['app_id'] = "";
			$temp_default['facebook']['app_secret'] = "";
			...
			$temp_default['live']['client_id'] = "";
			$temp_default['live']['client_secret'] = "";
			$temp_default['linked']['client_id'] = "";
			$temp_default['linked']['client_secret'] = "";
			...
			$temp_default['yahoo']['consumer_key'] = "";
			$temp_default['yahoo']['consumer_secret'] = "";
			$temp_default['insta']['client_id'] = "";
			$temp_default['insta']['client_secret'] = "";
			$temp_default['amazon']['client_id'] = "";
			$temp_default['amazon']['client_secret'] = "";
			$temp_default['pay']['client_id'] = "";
			$temp_default['pay']['client_secret'] = "";
			$temp_default['foursquare']['client_id'] = "";
			$temp_default['foursquare']['client_secret'] = "";
			$temp_default['github']['client_id'] = "";
			$temp_default['github']['client_secret'] = "";
			$temp_default['disqus']['client_id'] = "";
			$temp_default['disqus']['client_secret'] = "";
			$temp_default['vk']['client_id'] = "";
			$temp_default['vk']['client_secret'] = "";
			$temp_default['wordpress']['client_id'] = "";
			$temp_default['wordpress']['client_secret'] = "";
			$temp_default['dropbox']['client_id'] = "";
			$temp_default['dropbox']['client_secret'] = "";
...
//		$this->context->controller->addJs($this->_path.'views/js/flot/jquery.flot.tooltip_0.5.js');
	...
	public function hookDisplayHeader()
	{
		...
		{
                        $this->context->controller->addJs($this->_path.'views/js/login_page.js');
				...
				else
				{
					$this->smarty->assign(array(
						...
						'position' => $plugin_data[$page_name]['position']
                                ...
                                $this->context->controller->addJs($this->_path . 'views/js/custom-social-login.js');
                        	if (isset($plugin_data['enable']) && $plugin_data['enable'] == 1)
